...
def embedding_node(node_attribute_list):
    ...
    for j in range(0, len(node_attribute_list)):
        ...
        if v in main_point:
            ...
            vfm4 = v2o.sn2vecEmbedding(str(node_attribute_list[j][4]))
            ...
            vfm3 = v2o.sn2vecEmbedding(str(node_attribute_list[j][3]))
...
def embedding_edge(edge_list):
    ...
    for k in range(len(edge_list)):
        ...
        efm2 = v2o.sn2vecEmbedding(str(b))
...
if __name__ == "__main__":
    ...
    # current_detected_contract = "simple_dao.sol"
    node_feature, edge_feature = generate_graph("../data/reentrancy/contract/" + current_detected_contract)

    node_attribute_list, extra_var_list = elimination_node(node_feature)
    ...
    graph_output = open('../data/reentrancy/valid.json', 'w')
    contract_name = open("./reentrancy_contract_name.txt", "r")  # contracts list
    contract_label = open("./reentrancy_contract_label.txt", "r")  # contracts label
